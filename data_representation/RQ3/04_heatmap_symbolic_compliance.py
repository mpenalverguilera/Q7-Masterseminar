...
# Explode both symbolic architectures and compliance reasoning
...
long_df = merged.explode('symbolic_architecture_list').explode('compliance_reasoning_list')
long_df = long_df.dropna(subset=['symbolic_architecture_list', 'compliance_reasoning_list'])
...
# Create crosstab
df_absolute = long_df.groupby(['symbolic_architecture_list', 'compliance_reasoning_list']).size().unstack(fill_value=0)
...
plt.title('Intersection Analysis: Symbolic Approaches vs. Compliance Reasoning (Absolute)', fontsize=16, pad=20)
plt.ylabel('Symbolic Approach', fontsize=12)
plt.xlabel('Compliance Reasoning', fontsize=12)
plt.xticks(rotation=45, ha='right')
plt.tight_layout()
plt.savefig('04_heatmap_symbolic_compliance_absolute.pdf', dpi=300)
plt.close()
...
plt.title('Intersection Analysis: Symbolic Approaches vs. Compliance Reasoning (Normalized)', fontsize=16, pad=20)
plt.ylabel('Symbolic Approach', fontsize=12)
plt.xlabel('Compliance Reasoning', fontsize=12)
plt.xticks(rotation=45, ha='right')
plt.tight_layout()
plt.savefig('04_heatmap_symbolic_compliance_normalized.pdf', dpi=300)
plt.close()
